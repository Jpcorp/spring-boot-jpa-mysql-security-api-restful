package cl.espacio.ws.api.util;

public class ResponseUtils {
	
	public static final Object MSG_NOT_DELETE = "Usuario no se elimino o no existe";
	public static final Object MSG_OK_DELETE = "Se elimino con exito";
    public static final String MSG_OK_CREATED = "Se a creado con exitos";
